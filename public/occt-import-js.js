var occtimportjs = (() => {
  ...
  return function (occtimportjs = {}) {
    ...
    if (!isDataURI(wasmBinaryFile)) {
      wasmBinaryFile =
        /* locateFile(wasmBinaryFile) */ './public/occt-import-js.wasm'
    }
    ...
    var ___wasm_call_ctors = function () {
      return (___wasm_call_ctors = Module['asm']['aa']).apply(null, arguments)
    }
    var _malloc = function () {
      return (_malloc = Module['asm']['ca']).apply(null, arguments)
    }
    var _free = function () {
      return (_free = Module['asm']['da']).apply(null, arguments)
    }
    var ___errno_location = function () {
      return (___errno_location = Module['asm']['ea']).apply(null, arguments)
    }
    ...
    var _htons = function () {
      return (_htons = Module['asm']['ha']).apply(null, arguments)
    }
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module['asm']['ia']).apply(
        null,
        arguments
      )
    }
    var ___trap = function () {
      return (___trap = Module['asm']['ja']).apply(null, arguments)
    }
    ...
    var ___start_em_js = (Module['___start_em_js'] = 2617224)
    var ___stop_em_js = (Module['___stop_em_js'] = 2617520)
    var calledRun
